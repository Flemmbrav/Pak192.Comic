...
compile() {
    ...
    for dat in $3; do
        ...
        if [ -f "$dat" ] ; then
            ...
            ./makeobj pak$1 ./compiled_all_DACH/ "./$dat" &> /dev/null
                if [[ $? != 0 ]]; then
...
if [ ! -d 'compiled_all_DACH' ]; then
    mkdir compiled_all_DACH
fi

csv=compiled_all_DACH/compiled_all_DACH.csv
...
compile '192' 'AddOns 3/5' 'calculated/AddOn/austrian/**/**/*.dat'
compile '192' 'AddOns 4/5' 'calculated/AddOn/austrian/**/**/**/*.dat'
compile '192' 'AddOns 5/5' 'calculated/AddOn/austrian/**/**/**/**/*.dat'
compile '192' 'AddOns 1/5' 'calculated/AddOn/german/*.dat'
compile '192' 'AddOns 2/5' 'calculated/AddOn/german/**/*.dat'
compile '192' 'AddOns 3/5' 'calculated/AddOn/german/**/**/*.dat'
compile '192' 'AddOns 4/5' 'calculated/AddOn/german/**/**/**/*.dat'
compile '192' 'AddOns 5/5' 'calculated/AddOn/german/**/**/**/**/*.dat'
compile '192' 'AddOns 1/5' 'calculated/AddOn/swiss/*.dat'
compile '192' 'AddOns 2/5' 'calculated/AddOn/swiss/**/*.dat'
compile '192' 'AddOns 3/5' 'calculated/AddOn/swiss/**/**/*.dat'
compile '192' 'AddOns 4/5' 'calculated/AddOn/swiss/**/**/**/*.dat'
compile '192' 'AddOns 5/5' 'calculated/AddOn/swiss/**/**/**/**/*.dat'
compile '192' 'AddOns 1/5' 'calculated/AddOn/uni/*.dat'
compile '192' 'AddOns 2/5' 'calculated/AddOn/uni/**/*.dat'
...
cp -r calculated/pakset/trunk/* compiled_all_DACH
